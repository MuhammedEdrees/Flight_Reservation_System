...
public class FlightAgentUI extends javax.swing.JFrame {
    ...
    private void UpdateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateButtonActionPerformed
        if(!emptyField() || idTxt.getText().equals("")){
            getFlightFields();
            Flight flight1=new Flight(flightId);
            flight1.setAll(departureAirport,arrivalAirport,flightDate,departureTime,flightDuration,basePrice,airline,seatCapacity,seatCapacity);
            updateFlightsTable();
            clearFlightFields();
        } else {
    ...
    private void AddButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddButtonActionPerformed
        ...
        if(!emptyField()){
            getFlightFields();
            flight1=new Flight(departureAirport,arrivalAirport,flightDate,departureTime,flightDuration,basePrice,airline,seatCapacity,seatCapacity);
            updateFlightsTable();
            clearFlightFields();
        } else {
            JOptionPane.showMessageDialog(null, "Complete Missing Data Fields!");
