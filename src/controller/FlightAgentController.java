...
public class FlightAgentController {
    ...
    public void handleAddFlightButtonClick() {
        if (validator.validateId(view.getFlightId()) == false) {
            ...
            DefaultTableModel model1 = view.getFlightTableModel();
            DefaultTableModel model2 = view.getReservationTableModel();

            updateFlightsTableModel(model1);
            updateReservationsTableModel(model2);
        }
