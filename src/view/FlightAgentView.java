...
public class FlightAgentView extends javax.swing.JFrame {
    ...
    public void getFlightFields() {
        ...
        flightId = Integer.parseInt(idTxt.getText().trim());
    ...
    //my getters functions
    public Date getFlightDate() {
        return flightDateChooser.getDate();
    }

    public int getFlightId() {
        return Integer.parseInt(idTxt.getText().trim());
    }

    public int getSeatCapacity() {
        return Integer.parseInt(SeatCapacityTxt.getText().trim());
    }

    public String getDepartureAirport() {
        return (String) departureAirportBox.getSelectedItem();
    }

    public String getArrivalAirport() {
        return (String) arrivalAirportBox.getSelectedItem();
    }

    public String getDepartureTime() {
        return departureTimeTxt.getText();
    }
    ...
    public String getAirline() {
        return airlineTxt.getText();
    }

    public double getBasePrice() {
        return Double.parseDouble(priceTxt.getText());
    }
    public DefaultTableModel getFlightTableModel(){
        return (DefaultTableModel) FlightsTable.getModel();
    }
    ...
    private void initComponents() {
        ...
        SeatCapacityTxt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SeatCapacityTxtActionPerformed(evt);
            }
        });
    ...
    private void FlightManagementTabPanelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_FlightManagementTabPanelMouseClicked
        ...
        FlightManagementTabPanel.setBackground(new Color(94, 170, 211));
        ReservationsTabPanel.setBackground(new Color(53, 146, 196));
        controller.updateFlightsTableModel((DefaultTableModel) FlightsTable.getModel());
    ...
    private void ReservationsTabPanelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ReservationsTabPanelMouseClicked
        ...
        controller.updateReservationsTableModel((DefaultTableModel) ReservationsTable.getModel());
    }//GEN-LAST:event_ReservationsTabPanelMouseClicked

    private void SeatCapacityTxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SeatCapacityTxtActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_SeatCapacityTxtActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FlightAgentView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
